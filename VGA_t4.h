...
public:
  ...
  void drawBitmap(vga_pixel* _pixels, uint8_t _bitmap_size_px, int16_t _x, int16_t _y, uint16_t crop_top, uint16_t crop_bottom, uint16_t crop_left, uint16_t crop_right, bool _log, bool _render);
